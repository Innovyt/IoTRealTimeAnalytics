...
import innovyt.com.driverfit.http.auth.ApiKeyAuth;
import innovyt.com.driverfit.http.auth.HttpBasicAuth;
import innovyt.com.driverfit.http.auth.OAuth;
import innovyt.com.driverfit.http.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
    ...
    public void createDefaultAdapter() {
        //Type collectionType = new TypeToken<Items<Stops>>(){}.getType();
        Gson gson = new GsonBuilder()
                .setDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ")
                .registerTypeAdapter(DateTime.class, new DateTimeTypeAdapter())
                .registerTypeAdapter(LocalDate.class, new LocalDateTypeAdapter())
                //.registerTypeAdapter(collectionType, new StopsAdapter())
                .create();
